                        ...
                        <v-layout row wrap align-center>
                            <v-flex xs12 md4>
                                <v-card class="elevation-0 transparent">
                                    ...
                                    <v-card-text>
                                        Show your writing to all your friends not only to your mum or your friends. We love sharing great content. In this moment our editor is used by scientists all over the world who are not famous but that want to share their works to the world.
                                    </v-card-text>
                                </v-card>
                            </v-flex>
                            <v-flex xs12 md4>
                                <v-card class="elevation-0 transparent">
                                    ...
                                    <v-card-text>
                                        Time is important, we don't want you to waste it. Here you can preview your document in real time. And if you've made a mistake, you can easily revert your document to an earlier state and continue writing up a new idea.
                                    </v-card-text>
                                </v-card>
                            </v-flex>
                            <v-flex xs12 md4>
