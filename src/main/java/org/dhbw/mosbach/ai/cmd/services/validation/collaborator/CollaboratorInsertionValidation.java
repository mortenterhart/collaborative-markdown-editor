...
public class CollaboratorInsertionValidation implements ModelValidation<CollaboratorInsertionModel> {
    ...
    public ValidationResult validate(@NotNull CollaboratorInsertionModel model) {
        ...
        ValidationResult collaboratorUsernameSpecifiedCheck = basicFieldValidation.checkSpecified(JsonParameters.COLLABORATOR_USERNAME, collaboratorUsername);
        ...
        return ValidationResult.success("Collaborator can be added to the document");
    }
